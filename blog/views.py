...
def iicheteam(request):
    return render(request, 'blog/iicheteam.html')
def cheateam17(request):
    return render(request, 'blog/cheateam17.html')
def iicheteam17(request):
    return render(request, 'blog/iicheteam17.html')
def Chemical(request):
    return render(request, 'blog/Chemical.html')
def aboutchea(request):
